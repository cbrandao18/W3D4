...
def neighbors_of_certain_b_countries
  ...
  FROM countries
  where name = 'Belize') OR continent = (SELECT continent FROM countries WHERE name = 'Belgium')
...
def sparse_continents
  ...
  # outter select:
  #   all the countries where their continent is IN inner select
  # 
  # inner select: 
  #     get continent where the MAX(population) is 25mil
end
